...
# Or script only: wget https://raw.githubusercontent.com/DarkSecNetwork/ragnar-displayhatmini/main/install_ragnar.sh && sudo chmod +x install_ragnar.sh && sudo ./install_ragnar.sh
# On Raspberry Pi: choose e-Paper HAT, Display HAT Mini (option 9), server/headless, or Pineapple Pager. Reboot when it finishes.
```
...
- **This repo (Display HAT Mini / installer)**: [DarkSecNetwork/ragnar-displayhatmini](https://github.com/DarkSecNetwork/ragnar-displayhatmini) — [Issues](https://github.com/DarkSecNetwork/ragnar-displayhatmini/issues)
- **Ragnar upstream**: PierreGode — [PierreGode/Ragnar](https://github.com/PierreGode/Ragnar)
