...
- **Optional:** [PiSugar UPS](https://www.pisugar.com/) — the installer can install `pisugar-server` if you answer **y** when prompted.
...
4. **Static IP** — Optional; writes to `/etc/dhcpcd.conf` and optionally applies immediately.
